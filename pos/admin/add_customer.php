...
if (isset($_POST['addCustomer'])) {
  ...
  if (empty($_POST["customer_phoneno"]) || empty($_POST["customer_name"]) || empty($_POST['customer_email']) || empty($_POST['customer_password'])) {
    ...
    if ($postStmt) {
      $success = "Sucesso" && header("refresh:1; url=customes.php");
    } else {
      $err = "Desculpa tente de novo";
    }
  }
}
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="addCustomer" value="Adicionar" class="btn btn-success" value="">
                  </div>
                </div>
              </form>
            </div>
