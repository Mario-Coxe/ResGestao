...
if (isset($_POST['make'])) {
  ...
  if (empty($_POST["order_code"]) || empty($_POST["customer_name"]) || empty($_GET['prod_price'])) {
    ...
    if ($postStmt) {
      $success = "Venda Submetida" && header("refresh:1; url=payments.php");
    } else {
            ...
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                ?>
                  <div class="form-row">
                    <div class="col-md-6">
                      <label>Preço do produto (kz)</label>
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="make" value="Fazer Venda" class="btn btn-success" value="">
                  </div>
                </div>
              </form>
            </div>
