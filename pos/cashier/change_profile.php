...
if (isset($_POST['ChangeProfile'])) {
    ...
    if ($postStmt) {
        $success = "Conta Actualizada" && header("refresh:1; url=dashboard.php");
    } else {
        $err = "Tente Novamente";
    }
}
    ...
    if (!$error) {
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if ($old_password != $row['staff_password']) {
                $err =  "Por favo adicione a senha antigad";
                ...
                //declare a varible which will be passed to alert function
                if ($stmt) {
                    $success = "Senha Mudada" && header("refresh:1; url=dashboard.php");
                } else {
