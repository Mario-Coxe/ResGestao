...
if (isset($_POST['changePassword'])) {
    ...
    if (isset($_POST['old_password']) && !empty($_POST['old_password'])) {
        ...
        $error = 1;
        $err = "Antiga senha não poder ser vazia";
      }
      if (isset($_POST['new_password']) && !empty($_POST['new_password'])) {
        $new_password = mysqli_real_escape_string($mysqli, trim(sha1(md5($_POST['new_password']))));
      } else {
        $error = 1;
        $err = "Nova senha não poder ser vazia";
      }
      if (isset($_POST['confirm_password']) && !empty($_POST['confirm_password'])) {
        $confirm_password = mysqli_real_escape_string($mysqli, trim(sha1(md5($_POST['confirm_password']))));
      } else {
        $error = 1;
        $err = "Confirmação da senha não pode ser vazia";
      }
    ...
    if (!$error) {
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if ($old_password != $row['customer_password']) {
                $err =  "Porfavo adicione a senha antiga";
            } elseif ($new_password != $confirm_password) {
                $err = "Desculpe, as senhas não se correspondem";
            } else {
                ...
                //declare a varible which will be passed to alert function
                if ($stmt) {
                    $success = "Senha Alterada" && header("refresh:1; url=dashboard.php");
                } else {
                ...
                <div class="container-fluid d-flex align-items-center">
                    <div class="row">
                        <div class="col-lg-7 col-md-10">
                            ...
                            <p class="text-white mt-0 mb-5">Esta é a página do seu perfil . Tu podes costumizar teu perfil, bem como alterar a sua Senha</p>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-username">Nome do Usuário</label>
                                            ...
                                            <div class=" col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-email">Número de Telefone</label>
                                ...
                                <form method =" post">
                                        ...
                                        <div class="pl-lg-4">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="input-username">Senha Antiga</label>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="input-email">Confirmar nova senha</label>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="submit" id="input-email" name="changePassword" class="btn btn-success form-control-alternative" value="Alterar Senha">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
