...
if (isset($_POST['pay'])) {
  ...
  if (empty($_POST["pay_code"]) || empty($_POST["pay_amt"]) || empty($_POST['pay_method'])) {
    ...
    $pay_Code = $_POST['pay_code'];
      ...
      {
        $err = "Código de verificação de pagamento não conresponde, Tente Novamente";
      }
      ...
      else
      {
          ...
          if ($upStmt && $postStmt) {
              $success = "Pago" && header("refresh:1; url=payments_reports.php");
          } else {
              $err = "Tente Novamente";
          }
      }
            ...
            <div class="card-body">
              <form method="POST"  enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    <label>Código de Pagamento</label><small class="text-danger"> </small>
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="pay" value="Comprar" class="btn btn-success" value="">
                  </div>
                </div>
              </form>
            </div>
